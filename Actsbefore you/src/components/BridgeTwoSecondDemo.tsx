  ...
  return (
    <div className="relative w-full h-full">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        {/* Final message - "Acts before you ask." */}
        <motion.div
        ...
        >
          ...
          >
            <h2 className="text-[#E7D7BA] text-4xl tracking-tight">
              Acts before you ask.
            </h2>
          </motion.div>

          {/* Small Bridge icon pulse */}
          <motion.div
            className="mt-4 mx-auto w-10 h-10 rounded-full bg-gradient-to-br from-[#FE8E49] to-[#CD7640] flex items-center justify-center"
