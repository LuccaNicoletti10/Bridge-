export function Frame2() {
  return (
    <div className="relative w-full h-full bg-[#211F1F] rounded-lg overflow-hidden border border-[#3B3A3A] flex flex-col items-center justify-center">
      ...
      {/* Chat Bubble */}
      <div 
        className="relative px-5 py-2.5 bg-[#373131] rounded-full text-sm"
        style={{
