  ...
  return (
    <div className="relative w-full h-full">
      ...
      {windows.map((window, i) => (
        ...
        >
          <div
            className="bg-[#1A1A1A]/80 backdrop-blur-sm rounded-xl border border-[#E7D7BA]/20 overflow-hidden"
            style={{
              width: window.width,
          ...
          >
            {/* Window header */}
            <div className="h-10 border-b border-[#E7D7BA]/10 flex items-center px-4 gap-3">
              ...
              <span className="ml-1 text-[#E7D7BA]/80 text-sm">
            ...
            <div className="p-4 space-y-3">
              ...
              <div className="h-2 bg-[#E7D7BA]/20 rounded w-5/6"></div>
              <div className="h-12 bg-[#E7D7BA]/10 rounded mt-4"></div>
            </div>
          </div>
        </motion.div>
      ))}
      ...
      >
        <div
          className="w-[450px] h-[280px] bg-[#1A1A1A] rounded-xl border border-[#FE8E49]/50 overflow-hidden"
          style={{
            boxShadow: "0 20px 60px rgba(254, 142, 73, 0.3)",
          }}
        >
          {/* Window header */}
          <div className="h-10 border-b border-[#FE8E49]/30 flex items-center px-4 gap-3">
            ...
            <span className="ml-1 text-[#E7D7BA] text-sm">
              📊 Your Workflow
            </span>
          </div>
          ...
          <div className="p-5 space-y-3">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FE8E49] to-[#CD7640]"></div>
              <div className="flex-1 space-y-2">
                <div className="h-2 bg-[#E7D7BA]/40 rounded w-3/4"></div>
                <div className="h-2 bg-[#E7D7BA]/30 rounded w-1/2"></div>
              </div>
            </div>
            <div className="h-px bg-[#E7D7BA]/10"></div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#E7D7BA] to-[#E8D9BC]"></div>
              <div className="flex-1 space-y-2">
                <div className="h-2 bg-[#E7D7BA]/40 rounded w-2/3"></div>
                <div className="h-2 bg-[#E7D7BA]/30 rounded w-3/5"></div>
              </div>
            </div>
            <div className="h-px bg-[#E7D7BA]/10"></div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-[#FE8E49]/60 to-[#E7D7BA]"></div>
              <div className="flex-1 space-y-2">
                <div className="h-2 bg-[#E7D7BA]/40 rounded w-4/5"></div>
                <div className="h-2 bg-[#E7D7BA]/30 rounded w-2/5"></div>
              </div>
            </div>
          </div>
        </div>
      ...
      >
        <motion.h2
          className="text-[#E7D7BA] text-3xl tracking-tight"
          style={{ fontFamily: "Inter, system-ui, sans-serif" }}
          animate={{
            textShadow: [
              "0 0 0px rgba(254, 142, 73, 0)",
              "0 0 20px rgba(254, 142, 73, 0.4)",
            ],
          }}
          transition={{
            delay: 1.6,
        ...
        <motion.p
          className="mt-2 text-[#E8D9BC]/80 text-sm tracking-wide"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          transition={{ delay: 1.7, duration: 0.3 }}
        >
          Learns your patterns — quietly, without disruption.
        </motion.p>
      </motion.div>
