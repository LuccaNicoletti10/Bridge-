...
const Skeleton = () => {
  ...
  return (
    <div
      className="p-8 overflow-hidden h-full relative flex flex-col items-center justify-center gap-10"
  ...
  return (
    <div className="relative flex items-center justify-center orb-glow">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(255,255,255,0.1) 0%, rgba(255,255,255,0.05) 30%, rgba(255,255,255,0.02) 60%, transparent 100%)",
          filter: "blur(40px)",
        }}
      ></div>
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(255,255,255,0.15) 0%, rgba(255,255,255,0.08) 40%, rgba(255,255,255,0.03) 70%, transparent 100%)",
          filter: "blur(30px)",
        }}
      ></div>
      <div
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle at 35% 35%, rgba(255,255,255,0.12) 0%, rgba(255,255,255,0.06) 40%, rgba(255,255,255,0.03) 70%, rgba(255,255,255,0.01) 100%)",
        }}
      >
        <ChatbotIcon />
      </motion.div>
...
const ChatbotIcon = () => {
  return (
    ...
    >
      ...
      {/* Chat bubble tail */}
      <path d="M 45 67 L 41 74 L 50 67 Z" fill="white" />
...
export const CardTitle = ({
  ...
  return (
    <h3 className={cn("text-white py-2", className)}>
      {children}
    </h3>
  );
};
